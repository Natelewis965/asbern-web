...
var AsbernDash = (function () {
  ...
  var REGISTRY = /* ---- GENERATED — 369 actions, 11 groups, fingerprint f336fb5ffd52b110.
  ...
  actions: [
    ...
    {"id":"bridge.health","label":"Health","help":"What is still not configured, and which optional integrations are not answering right now. Read-only — it changes nothing and can be run whenever.","group":"overview","emoji":"📋","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    ...
    {"id":"bridge.secondScreen","label":"Second Screen","help":"Let a second screening run at the same time on its own stream, so two groups can watch different things at once.","group":"media","emoji":"🎬","module":"second-screen","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    ...
    {"id":"bridge.trusted","label":"Trusted Users","help":"Who, besides your admins, may start a game server and grant access to a private category. Add or remove members here; everyone else is refused.","group":"members","emoji":"🛡️","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    ...
    {"id":"bridge.installRanks","label":"Install Rank Roles","help":"Creates one Discord role for every rank in the levelling ladder, so members get a visible role as they climb. A role that already exists by that name is reused, never duplicated.","group":"roles","emoji":"🪖","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    ...
    {"id":"member.ban","label":"Ban","help":"Ban a member, optionally deleting their recent messages. Works on someone who has already left.","group":"members","emoji":"🔨","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["BanMembers"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"purgeDays","label":"Delete messages from the last N days","type":"number","required":false,"help":"Discord allows up to 7. Blank or 0 keeps everything they posted.","choices":null,"min":0,"max":7,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"member.softban","label":"Softban (clear messages)","help":"Ban then immediately unban — deletes their recent messages without keeping them out.","group":"members","emoji":"🧹","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["BanMembers"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"purgeDays","label":"Delete messages from the last N days","type":"number","required":false,"help":"Discord allows up to 7. This is the whole point of a softban.","choices":null,"min":1,"max":7,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"member.unban","label":"Unban","help":"Lifts a ban so that account may come back. They still need an invite to rejoin.","group":"members","emoji":"🕊️","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["BanMembers"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"User id","type":"member","required":true,"help":"A user id — a banned account cannot be picked from a list. Ban List shows the ids.","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"member.addRole","label":"Add role","help":"Gives one member a role, with whatever reason you type recorded in Discord’s own audit log.","group":"members","emoji":"➕","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["ManageRoles"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"role","label":"Role","type":"role","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"member.removeRole","label":"Remove role","help":"Takes a role off one member. The role itself is not deleted and nobody else is affected.","group":"members","emoji":"➖","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["ManageRoles"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"role","label":"Role","type":"role","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"member.voiceKick","label":"Disconnect from voice","help":"Pulls one member out of voice entirely. Nothing stops them rejoining unless you also mute or time them out.","group":"members","emoji":"🔌","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["MoveMembers"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"member.voiceMute","label":"Server mute","help":"Silences a member in voice for everybody, or lifts it. It follows them between channels until you undo it.","group":"members","emoji":"🔇","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["MuteMembers"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"on","label":"Muted","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"member.voiceDeafen","label":"Server deafen","help":"Stops a member hearing anyone in voice, or lifts it. It follows them between channels until you undo it.","group":"members","emoji":"🙉","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["DeafenMembers"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"on","label":"Deafened","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"member.churn","label":"Joined / left this week","help":"How many people arrived and how many left over the days you choose, and which accounts they were.","group":"members","emoji":"📈","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"days","label":"Over the last N days","type":"count","required":false,"help":"","choices":null,"min":1,"max":90,"secret":false}]},
    {"id":"member.neverPosted","label":"Never posted","help":"Members who have never posted a message this bot has seen. Worth reading before a prune — it cannot see anything sent before the bot joined.","group":"members","emoji":"🙊","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"minDays","label":"Only if they joined over N days ago","type":"count","required":false,"help":"","choices":null,"min":1,"max":3650,"secret":false},{"name":"limit","label":"How many to list","type":"count","required":false,"help":"","choices":null,"min":1,"max":100,"secret":false}]},
    ...
    {"id":"member.copresence","label":"Who they hang out with","help":"Who this member actually shares a voice channel with, and how much time they spend together. Read-only.","group":"members","emoji":"🤝","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"days","label":"Over the last N days","type":"count","required":false,"help":"","choices":null,"min":1,"max":365,"secret":false},{"name":"limit","label":"How many partners","type":"count","required":false,"help":"","choices":null,"min":1,"max":25,"secret":false}]},
    {"id":"member.bulkRole","label":"Bulk add/remove role","help":"Give or take a role across everyone a filter matches. It shows you the full list and the count before anything changes.","group":"members","emoji":"🎭","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":true,"composite":false,"botPermission":{"need":["ManageRoles"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"role","label":"Has this role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"notRole","label":"Does NOT have this role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"inactiveDays","label":"No activity for N days","type":"count","required":false,"help":"Needs recorded activity; with none, this filter matches nobody.","choices":null,"min":null,"max":null,"secret":false},{"name":"joinedWithinDays","label":"Joined within N days","type":"count","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"accountYoungerDays","label":"Account younger than N days","type":"count","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"namePattern","label":"Display name contains","type":"pattern","required":false,"help":"Plain text matches anywhere in the name; wrap it in /slashes/ for a pattern.","choices":null,"min":null,"max":null,"secret":false},{"name":"includeBots","label":"Include bots","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"everyone","label":"Yes — EVERY member","type":"boolean","required":false,"help":"Required when no other filter is set, so a blank form cannot touch the whole server.","choices":null,"min":null,"max":null,"secret":false},{"name":"op","label":"Operation","type":"enum","required":true,"help":"","choices":[{"value":"add","label":"Add the role"},{"value":"remove","label":"Remove the role"}],"min":null,"max":null,"secret":false},{"name":"target","label":"Role to add/remove","type":"role","required":true,"help":"The role actually added or removed. The filters above only decide who it happens to.","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"member.bulkTimeout","label":"Bulk timeout","help":"Time out everyone a filter matches. It shows you the full list and the count before anybody is muted.","group":"members","emoji":"⏳","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":true,"composite":false,"botPermission":{"need":["ModerateMembers"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"role","label":"Has this role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"notRole","label":"Does NOT have this role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"inactiveDays","label":"No activity for N days","type":"count","required":false,"help":"Needs recorded activity; with none, this filter matches nobody.","choices":null,"min":null,"max":null,"secret":false},{"name":"joinedWithinDays","label":"Joined within N days","type":"count","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"accountYoungerDays","label":"Account younger than N days","type":"count","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"namePattern","label":"Display name contains","type":"pattern","required":false,"help":"Plain text matches anywhere in the name; wrap it in /slashes/ for a pattern.","choices":null,"min":null,"max":null,"secret":false},{"name":"includeBots","label":"Include bots","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"everyone","label":"Yes — EVERY member","type":"boolean","required":false,"help":"Required when no other filter is set, so a blank form cannot touch the whole server.","choices":null,"min":null,"max":null,"secret":false},{"name":"preset","label":"How long","type":"enum","required":false,"help":"","choices":[{"value":"60s","label":"60 seconds"},{"value":"5m","label":"5 minutes"},{"value":"10m","label":"10 minutes"},{"value":"1h","label":"1 hour"},{"value":"1d","label":"1 day"},{"value":"1w","label":"1 week"},{"value":"custom","label":"Custom…"}],"min":null,"max":null,"secret":false},{"name":"custom","label":"Custom duration","type":"duration","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"member.bulkKick","label":"Bulk kick","help":"Kick everyone a filter matches. It always shows you the full list and the count first, and nobody is removed until you confirm it.","group":"members","emoji":"🥾","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":true,"composite":false,"botPermission":{"need":["KickMembers"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"role","label":"Has this role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"notRole","label":"Does NOT have this role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"inactiveDays","label":"No activity for N days","type":"count","required":false,"help":"Needs recorded activity; with none, this filter matches nobody.","choices":null,"min":null,"max":null,"secret":false},{"name":"joinedWithinDays","label":"Joined within N days","type":"count","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"accountYoungerDays","label":"Account younger than N days","type":"count","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"namePattern","label":"Display name contains","type":"pattern","required":false,"help":"Plain text matches anywhere in the name; wrap it in /slashes/ for a pattern.","choices":null,"min":null,"max":null,"secret":false},{"name":"includeBots","label":"Include bots","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"everyone","label":"Yes — EVERY member","type":"boolean","required":false,"help":"Required when no other filter is set, so a blank form cannot touch the whole server.","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"member.normaliseNicknames","label":"Normalise nicknames","help":"Strip hoisting punctuation and invisible characters from display names. It shows you every name it would change before changing any of them.","group":"members","emoji":"✒️","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":true,"composite":false,"botPermission":{"need":["ManageNicknames"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"role","label":"Has this role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"notRole","label":"Does NOT have this role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"inactiveDays","label":"No activity for N days","type":"count","required":false,"help":"Needs recorded activity; with none, this filter matches nobody.","choices":null,"min":null,"max":null,"secret":false},{"name":"joinedWithinDays","label":"Joined within N days","type":"count","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"accountYoungerDays","label":"Account younger than N days","type":"count","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"namePattern","label":"Display name contains","type":"pattern","required":false,"help":"Plain text matches anywhere in the name; wrap it in /slashes/ for a pattern.","choices":null,"min":null,"max":null,"secret":false},{"name":"includeBots","label":"Include bots","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"everyone","label":"Yes — EVERY member","type":"boolean","required":false,"help":"Required when no other filter is set, so a blank form cannot touch the whole server.","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"channel.pin","label":"Pin a message","help":"Pins one message so it shows in the channel’s pinned list for everyone who opens it.","group":"channels","emoji":"📌","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["ManageMessages"],"mode":"all","scope":"channel","param":"channel","hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"channel","label":"Channel","type":"channel","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"message","label":"Message id","type":"string","required":true,"help":"Turn on Discord’s Developer Mode, then right-click the message and Copy Message ID.","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"channel.unpin","label":"Unpin a message","help":"Takes one message out of a channel’s pinned list. The message itself stays where it is.","group":"channels","emoji":"📍","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["ManageMessages"],"mode":"all","scope":"channel","param":"channel","hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"channel","label":"Channel","type":"channel","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"message","label":"Message id","type":"string","required":true,"help":"Turn on Discord’s Developer Mode, then right-click the message and Copy Message ID.","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"channel.sync","label":"Sync to category","help":"Replaces a channel’s own permissions with its category’s. Any override set on the channel itself is lost, which is usually the point — use “Permission drift” first to see what would change.","group":"channels","emoji":"🔗","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageChannels","ManageRoles"],"mode":"all","scope":"channel","param":"channel","hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"channel","label":"Channel","type":"channel","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"channel.drift","label":"Permission drift","help":"Channels whose permissions no longer match the category they sit in. Read-only — “Sync to category” is the control that fixes one.","group":"channels","emoji":"🧮","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"category","label":"Only this category","type":"category","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"channel.preset","label":"Apply a preset","help":"Sets what @everyone may do in one channel — public, read-only, private or archived. Only @everyone is changed; overrides for other roles and members are left exactly as they are.","group":"channels","emoji":"🎚️","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageRoles"],"mode":"all","scope":"channel","param":"channel","hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"channel","label":"Channel","type":"channel","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"preset","label":"Preset","type":"enum","required":true,"help":"","choices":[{"value":"public","label":"Public — anyone can read and post"},{"value":"readonly","label":"Read-only — anyone can read, nobody posts"},{"value":"private","label":"Private — hidden from @everyone"},{"value":"archive","label":"Archived — visible but frozen"}],"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"webhook.delete","label":"Delete webhook","help":"Remove a webhook. Anything posting through it stops immediately.","group":"channels","emoji":"🧨","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageWebhooks"],"mode":"all","scope":"channel","param":"channel","hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"channel","label":"Channel","type":"channel","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"webhook","label":"Webhook id","type":"string","required":true,"help":"The webhook id, as listed by List webhooks on the same channel.","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"channel.activity","label":"Channel activity","help":"Messages per day per channel, and who posts in them.","group":"channels","emoji":"📈","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"window","label":"Window","type":"enum","required":false,"help":"How far back to count. “all” uses every day on record.","choices":[{"value":"day","label":"day"},{"value":"week","label":"week"},{"value":"month","label":"month"},{"value":"year","label":"year"},{"value":"all","label":"all"}],"min":null,"max":null,"secret":false},{"name":"channel","label":"Only this channel","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"limit","label":"How many channels","type":"count","required":false,"help":"","choices":null,"min":1,"max":25,"secret":false}]},
    {"id":"channel.dead","label":"Dead channels","help":"Channels with no messages recorded in the window you pick. Channels the bot cannot measure are listed separately rather than counted as dead.","group":"channels","emoji":"🪦","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"window","label":"Window","type":"enum","required":false,"help":"How far back to look. A channel silent for a day is not a dead channel.","choices":[{"value":"day","label":"day"},{"value":"week","label":"week"},{"value":"month","label":"month"},{"value":"year","label":"year"},{"value":"all","label":"all"}],"min":null,"max":null,"secret":false}]},
    {"id":"channel.ignored","label":"Excluded channels","help":"Channels the bot has been told to leave out, and what that actually stops. The no-XP list and the live-TV lineup are separate lists and are reported separately.","group":"channels","emoji":"🚫","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    ...
    {"id":"guild.icon","label":"Server Icon","help":"Replaces the server icon with an image you link to. Everyone sees the change immediately.","group":"guild","emoji":"🖼️","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageGuild"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"url","label":"Image URL","type":"string","required":true,"help":"PNG/JPG/GIF. Leave blank in the modal to remove the icon.","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"guild.verification","label":"Verification Level","help":"How much Discord asks of an account before it may talk here — the single most effective anti-raid setting. It applies to everyone at once.","group":"guild","emoji":"🔒","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageGuild"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"level","label":"Verification Level","type":"enum","required":true,"help":"Low needs a verified email · Medium 5 minutes on Discord · High 10 minutes here · VeryHigh a phone.","choices":[{"value":"None","label":"None"},{"value":"Low","label":"Low"},{"value":"Medium","label":"Medium"},{"value":"High","label":"High"},{"value":"VeryHigh","label":"VeryHigh"}],"min":null,"max":null,"secret":false}]},
    {"id":"guild.contentFilter","label":"Content Filter","help":"Whether Discord scans attachments for explicit content, and whose. It changes what every member can post the moment you save it.","group":"guild","emoji":"🛡️","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageGuild"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"filter","label":"Content Filter","type":"enum","required":true,"help":"Whose attachments Discord scans: nobody, only members with no role, or everybody.","choices":[{"value":"Disabled","label":"Disabled"},{"value":"MembersWithoutRoles","label":"MembersWithoutRoles"},{"value":"AllMembers","label":"AllMembers"}],"min":null,"max":null,"secret":false}]},
    {"id":"guild.notifications","label":"Default Notifications","help":"What NEW members get by default: every message, or only mentions. Anybody who has already chosen for themselves keeps their choice.","group":"guild","emoji":"🔔","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageGuild"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"setting","label":"Default Notifications","type":"enum","required":true,"help":"AllMessages pings for every message. OnlyMentions pings only when somebody is mentioned.","choices":[{"value":"AllMessages","label":"AllMessages"},{"value":"OnlyMentions","label":"OnlyMentions"}],"min":null,"max":null,"secret":false}]},
    ...
    {"id":"emoji.add","label":"Add Emoji","help":"Upload a custom emoji from an image URL.","group":"guild","emoji":"➕","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["ManageGuildExpressions"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"name","label":"Emoji name","type":"string","required":true,"help":"What people will type between colons. Letters, digits and underscores only.","choices":null,"min":null,"max":null,"secret":false},{"name":"url","label":"Image URL","type":"string","required":true,"help":"PNG, JPG or GIF. Discord refuses anything over 256 KB.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"emoji.rename","label":"Rename Emoji","help":"Changes the name people type to use a custom emoji. Messages that already used it are unaffected.","group":"guild","emoji":"🏷️","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["ManageGuildExpressions"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"emoji","label":"Current name","type":"string","required":true,"help":"The name it is typed as now, without the colons.","choices":null,"min":null,"max":null,"secret":false},{"name":"name","label":"New name","type":"string","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"emoji.delete","label":"Delete Emoji","help":"Remove a custom emoji. Every message that used it shows the raw text instead.","group":"guild","emoji":"🗑️","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageGuildExpressions"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"emoji","label":"Emoji name","type":"string","required":true,"help":"The name it is typed as, without the colons.","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"automod.toggle","label":"Toggle AutoMod Rule","help":"Turns one of Discord’s own AutoMod rules on or off by name. Switching one off stops it filtering anything at once.","group":"guild","emoji":"🔀","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageGuild"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"name","label":"Rule name","type":"string","required":true,"help":"The rule name exactly as AutoMod Rules lists it.","choices":null,"min":null,"max":null,"secret":false},{"name":"on","label":"Enabled","type":"boolean","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"bot.feature.set","label":"Turn a feature on/off","help":"Turn one of the bot’s features on or off for this whole server. Takes effect at once. A feature with no switch of its own is refused with the reason instead.","group":"bot","emoji":"🔀","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"feature","label":"Feature","type":"enum","required":true,"help":"","choices":[{"value":"counting","label":"Counting game"},{"value":"content","label":"Challenges, goals & events"},{"value":"ai","label":"AI companions"},{"value":"booster","label":"Booster prison escalation"},{"value":"casino","label":"Casino games"},{"value":"economy","label":"Economy"},{"value":"leveling","label":"Levelling"},{"value":"wrapped","label":"Wrapped recap"}],"min":null,"max":null,"secret":false},{"name":"on","label":"On","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"channel","label":"Channel","type":"channel","required":false,"help":"Counting only — the channel it should watch.","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"bot.economy.grant","label":"Grant money","help":"Add currency to one member’s balance. It shows up in their ledger like money they earned, so they can see where it came from and you can reverse it later.","group":"bot","emoji":"💸","module":"economy","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"amount","label":"Amount","type":"number","required":true,"help":"","choices":null,"min":1,"max":1000000000000,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"bot.economy.reset.member","label":"Reset a member’s balance","help":"Set one member’s balance to zero. What they own, their lifetime totals and their net-worth tier all survive — only the cash goes. There is no way back.","group":"bot","emoji":"🧹","module":"economy","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"bot.economy.rates","label":"Payout rates","help":"Every rate the economy actually pays — per message, per voice minute, per daily claim. Read from the live figures rather than a document. Changes nothing.","group":"bot","emoji":"📈","module":"economy","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    ...
    {"id":"bot.economy.reverse","label":"Reverse a transaction","help":"Undo one entry in a member’s ledger by paying the exact opposite amount. The original entry stays on the record: a ledger you can quietly edit is not a ledger.","group":"bot","emoji":"↩️","module":"economy","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"entry","label":"Entry number (1 = newest)","type":"count","required":true,"help":"Counted from the newest in View a ledger: 1 is the most recent entry.","choices":null,"min":1,"max":40,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"bot.level.setxp","label":"Set XP","help":"Sets a member’s XP to exactly what you type, replacing whatever they had. Their level is worked out again from the new figure, with the same maths the game itself uses.","group":"bot","emoji":"✨","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"xp","label":"XP","type":"number","required":true,"help":"","choices":null,"min":0,"max":1000000000,"secret":false}]},
    ...
    {"id":"bot.level.recalc","label":"Recalculate levels","help":"Work out everyone’s level again from the XP they already hold. Fixes levels that went wrong after a hand-edit or a restore from a mismatched backup. No XP is changed.","group":"bot","emoji":"🧮","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"bot.level.season.reset","label":"Reset the levelling season","help":"Puts every member back to Lv 0 with 0 XP. Prestige, lifetime XP, achievements and equipped icons all survive. It backs up first and asks you to type the server name.","group":"bot","emoji":"🌱","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"confirm","label":"Type the server name to confirm","type":"string","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"bot.counting.set","label":"Set the count","help":"Set the counting game to a number of your choosing. Per-member records are kept, and the lock on who counted last is cleared so nobody is wrongly blocked.","group":"bot","emoji":"🔢","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"count","label":"Count","type":"number","required":true,"help":"","choices":null,"min":0,"max":9007199254740991,"secret":false}]},
    ...
    {"id":"bot.content.roll","label":"Force the rollover","help":"Ends any daily, weekly or seasonal challenge whose time is already up, right now, instead of waiting for the next automatic check. Anything still running is left alone.","group":"bot","emoji":"⏭️","module":"challenges","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"period","label":"Period","type":"enum","required":false,"help":"","choices":[{"value":"day","label":"Day"},{"value":"week","label":"Week"},{"value":"season","label":"Season"},{"value":"all","label":"Anything that has ended"}],"min":null,"max":null,"secret":false}]},
    ...
    {"id":"bot.casino.controls","label":"Casino controls","help":"What can and cannot be controlled about the casino, and exactly what each missing control would need first.","group":"bot","emoji":"🕹️","module":"casino","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    ...
    {"id":"bot.msg.say","label":"Say something","help":"Posts a message as the bot in a channel you choose. Every member can see it the moment it lands, and only “Edit a bot message” can change it afterwards.","group":"bot","emoji":"🗣️","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["SendMessages"],"mode":"all","scope":"channel","param":"channel","hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"channel","label":"Channel","type":"channel","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"text","label":"Message","type":"string","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"bot.msg.edit","label":"Edit a bot message","help":"Rewrites a message this bot sent. The old text is gone — Discord keeps no history of it — and the bot can only edit its own messages.","group":"bot","emoji":"✏️","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"channel","label":"Channel","type":"channel","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"message","label":"Message id","type":"string","required":true,"help":"Right-click the bot’s own message and Copy Message ID. It cannot edit anyone else’s.","choices":null,"min":null,"max":null,"secret":false},{"name":"text","label":"New message","type":"string","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"bot.msg.schedule","label":"Schedule a message","help":"Post a message as the bot after a delay of up to 24 hours. It is only held in memory, so restarting the bot cancels it — the result tells you so when you set it.","group":"bot","emoji":"⏰","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["SendMessages"],"mode":"all","scope":"channel","param":"channel","hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"channel","label":"Channel","type":"channel","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"text","label":"Message","type":"string","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"delay","label":"In how long (10m, 2h…)","type":"duration","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"bot.runtime.restart","label":"Restart the bot","help":"Save everything still in memory, then shut the bot down so it starts again. It is offline for a few seconds, and any menu somebody has open at that moment stops responding.","group":"bot","emoji":"♻️","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"bot.runtime.reload","label":"Reload config","help":"Re-read every setting from disk without restarting. Use it after editing the configuration files by hand. Nobody is disconnected and nothing else changes.","group":"bot","emoji":"🔄","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"bot.runtime.flushstats","label":"Flush stats","help":"Writes the message and voice counters still held in memory to disk now, instead of waiting for the next automatic save. Use it before a restart.","group":"bot","emoji":"💾","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"bot.runtime.backup","label":"Back up now","help":"Copy every file the bot writes to — money, levels, settings — into a dated backup folder, then read it back to check the copy landed. Nothing live is touched.","group":"bot","emoji":"🗄️","module":"backup","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    ...
    {"id":"diag.scan","label":"Run every diagnostic","help":"Reads the whole server and reports everything quietly broken: settings pointing at deleted channels and roles, categories nobody can be granted, roles the bot cannot assign, stale files. Changes nothing.","group":"overview","emoji":"🩺","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"diag.configDrift","label":"Config drift","help":"Settings that still point at a channel, role or category Discord no longer has — the silent kind of broken, where nothing errors and nothing happens. Read-only — it changes nothing, so run it whenever.","group":"overview","emoji":"🧭","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"diag.categories","label":"Categories & prisons","help":"Private categories nobody can be granted access to because they have no access role, and ones with no booster-prison voice channel. Read-only — it changes nothing, so run it whenever.","group":"overview","emoji":"🗂️","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"diag.roles","label":"Roles","help":"Roles the bot sits below and therefore cannot assign, roles holding Administrator, and roles nobody holds at all. Read-only — it changes nothing, so run it whenever.","group":"overview","emoji":"🛡️","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"diag.channels","label":"Channels","help":"Channels the bot cannot see or post in, and channels whose permissions have drifted away from the category they sit in. Read-only — it changes nothing, so run it whenever.","group":"overview","emoji":"👁️","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"diag.upkeep","label":"Settings & upkeep","help":"Required settings still unset, plus housekeeping: dead channels, backups going stale, and files that were quarantined. Read-only — it changes nothing, so run it whenever.","group":"overview","emoji":"🧰","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    ...
    {"id":"data.discordAudit","label":"Discord audit log","help":"Discord’s own audit log, read here instead of in the client. Shows bans, kicks, role and channel changes — including ones this bot did not make.","group":"data","emoji":"📖","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["ViewAuditLog"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"limit","label":"How many","type":"count","required":false,"help":"","choices":null,"min":1,"max":100,"secret":false},{"name":"type","label":"Audit log event type","type":"number","required":false,"help":"Discord’s own numeric event code. Leave it blank for every kind of entry.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"data.parity","label":"StatBot parity trend","help":"Every comparison run against an outside statistics bot, and whether the gap between its figures and this bot’s is closing. Read-only.","group":"data","emoji":"📈","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"limit","label":"How many runs","type":"count","required":false,"help":"","choices":null,"min":1,"max":50,"secret":false}]},
    ...
    {"id":"blueprint.staff","label":"Staff Kit","help":"A whole staff area: Staff and Moderator roles, a hidden category, mod-chat, a read-only mod-log and a staff voice channel — and it can make that mod-log the bot’s own staff log.","group":"blueprints","emoji":"🛡️","module":"blueprints","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":true,"botPermission":{"need":["ManageChannels","ManageRoles"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"name","label":"Category name","type":"string","required":false,"help":"Defaults to “Staff”.","choices":null,"min":null,"max":null,"secret":false},{"name":"staffRoleName","label":"Staff role name","type":"string","required":false,"help":"Defaults to “Staff”.","choices":null,"min":null,"max":null,"secret":false},{"name":"modRoleName","label":"Moderator role name","type":"string","required":false,"help":"Defaults to “Moderator”.","choices":null,"min":null,"max":null,"secret":false},{"name":"wireModLog","label":"Use the new mod-log as the staff log","type":"boolean","required":false,"help":"Points the bot’s own staff logging at the mod-log this kit creates.","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"blueprint.clone","label":"Clone a category","help":"Duplicates a category — its channels, their topics and every permission overwrite — under a new name. Give it a role name and it also creates a fresh access role and swaps it in wherever the original’s appeared.","group":"blueprints","emoji":"📋","module":"blueprints","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":true,"botPermission":{"need":["ManageChannels","ManageRoles"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"source","label":"Copy from","type":"category","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"name","label":"New category name","type":"string","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"roleName","label":"New access role name","type":"string","required":false,"help":"Leave blank to reuse the original’s permissions exactly.","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"media.restartEngine","label":"Restart the projector","help":"Restarts the projector for whatever is on and resumes from where it was. Everyone watching sees the picture drop for a few seconds.","group":"media","emoji":"♻️","module":"screening-room","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"screen","label":"Screen","type":"number","required":false,"help":"","choices":null,"min":0,"max":null,"secret":false}]},
    ...
    {"id":"tickets.setup","label":"Tickets — setup","help":"Turn the ticket system on or off, choose the category new ticket channels are created under, and set the channel closed tickets are archived to.","group":"guild","emoji":"⚙️","module":"tickets","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ViewChannel","SendMessages"],"mode":"all","scope":"channel","param":"transcriptChannel","hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"state","label":"Tickets","type":"enum","required":false,"help":"Leave blank to change the other settings without touching it.","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"parent","label":"Create ticket channels under","type":"category","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"transcriptChannel","label":"Archive closed tickets to","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"disclosure","label":"What members are told on the panel","type":"reason","required":false,"help":"Shown on the panel before anyone types. It cannot be blank — the default is used instead.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"tickets.category","label":"Tickets — category","help":"Add a ticket category or change one. Each carries its own label, staff roles, ping and per-member limit — which is what lets a single panel serve billing, reports and appeals at once.","group":"guild","emoji":"🗂️","module":"tickets","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"key","label":"Category key","type":"string","required":true,"help":"Lower-case letters, digits, - and _. It lands on every ticket, so a bad one is refused, not fixed.","choices":null,"min":null,"max":null,"secret":false},{"name":"label","label":"What members see","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"emoji","label":"Emoji","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"description","label":"One line of explanation","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"staffRole","label":"Staff role (can see and answer)","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"pingRole","label":"Ping this role on open","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"parent","label":"Create these channels under","type":"category","required":false,"help":"Overrides the default category set in Tickets — setup.","choices":null,"min":null,"max":null,"secret":false},{"name":"channelName","label":"Channel name template","type":"string","required":false,"help":"Tokens: {id} {user} {userid} {category}.","choices":null,"min":null,"max":null,"secret":false},{"name":"perMemberOpen","label":"Max open per member in this category","type":"number","required":false,"help":"","choices":null,"min":0,"max":50,"secret":false},{"name":"state","label":"Accepting tickets","type":"enum","required":false,"help":"Leave blank to change the other settings without touching it.","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false}]},
    {"id":"tickets.categoryRemove","label":"Tickets — remove a category","help":"Take a category off the ticket panel so nobody can open a new one in it. Tickets already opened through it are NOT touched and keep the category on their record.","group":"guild","emoji":"🗑️","module":"tickets","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"key","label":"Category key","type":"string","required":true,"help":"The category key exactly as it appears in Tickets — overview.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"tickets.form","label":"Tickets — form","help":"The questions a member is asked when they open a ticket in this category — up to five, which is Discord’s ceiling for one form. Answers are kept with the ticket; the messages in the channel are not.","group":"guild","emoji":"📝","module":"tickets","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"category","label":"Category key","type":"string","required":true,"help":"The category key exactly as it appears in Tickets — overview.","choices":null,"min":null,"max":null,"secret":false},{"name":"questions","label":"The questions, one per line","type":"reason","required":true,"help":"One per line, up to five. A single dash (-) clears the form. Add \"|long\" for a long answer box.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"tickets.policy","label":"Tickets — policy","help":"How many tickets one member may hold at once, the server-wide ceiling, the cooldown between opens, whether idle tickets close themselves, and whether members are asked to rate a ticket when it closes.","group":"guild","emoji":"⏳","module":"tickets","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"perMember","label":"Open tickets per member (0 = no limit)","type":"number","required":false,"help":"","choices":null,"min":0,"max":50,"secret":false},{"name":"guildOpen","label":"Open tickets server-wide (0 = no limit)","type":"number","required":false,"help":"","choices":null,"min":0,"max":5000,"secret":false},{"name":"cooldownSeconds","label":"Cooldown between opens, in seconds (0 = none)","type":"number","required":false,"help":"","choices":null,"min":0,"max":86400,"secret":false},{"name":"autoClose","label":"Close idle tickets","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"idleHours","label":"Idle for, in hours","type":"number","required":false,"help":"","choices":null,"min":1,"max":2160,"secret":false},{"name":"warnHours","label":"Warn this many hours before closing","type":"number","required":false,"help":"0 closes an idle ticket with no warning at all.","choices":null,"min":0,"max":720,"secret":false},{"name":"rating","label":"Ask for a rating on close","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"postTranscript","label":"Post the transcript on close","type":"enum","required":false,"help":"It goes to the archive channel set in Tickets — setup.","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false}]},
    ...
    {"id":"ticket.transfer","label":"Ticket — transfer","help":"Hand a ticket to another staff member, move it to a different category, or both. Every hand-over stays on the ticket, so you can always see who had it when something went wrong.","group":"members","emoji":"🔁","module":"tickets","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"ticket","label":"Ticket number","type":"count","required":true,"help":"","choices":null,"min":1,"max":null,"secret":false},{"name":"to","label":"Hand it to","type":"member","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"category","label":"Move it to this category key","type":"string","required":false,"help":"A category key from Tickets — overview. Blank keeps the one it has.","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"ticket.transcript","label":"Ticket — transcript","help":"Export a ticket as an HTML file. It contains the ticket — who opened it, what they were asked and answered, who handled it, how it ended — and deliberately contains no message text at all.","group":"members","emoji":"🧾","module":"tickets","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"ticket","label":"Ticket number","type":"count","required":true,"help":"","choices":null,"min":1,"max":null,"secret":false},{"name":"mode","label":"What to include","type":"enum","required":false,"help":"Metadata is the only mode: who, when, and the form answers. Message text is never exported.","choices":[{"value":"metadata","label":"Ticket record + the member's form answers"}],"min":null,"max":null,"secret":false}]},
    {"id":"ticket.purge","label":"Ticket — erase a member's tickets","help":"Delete a member's tickets and everything they typed into the ticket forms. This is the deletion path a data request is answered with, and it removes the rows outright rather than blanking them.","group":"members","emoji":"🗑️","module":"tickets","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"openToo","label":"Erase their OPEN tickets too","type":"boolean","required":false,"help":"Off by default — erasing an open ticket orphans a channel staff are still working in.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"engagement.feature","label":"Turn an engagement feature on or off","help":"Polls, suggestions, reminders, tags, the starboard, temporary voice rooms and birthdays. Every one of them starts OFF in every server and does nothing at all until you switch it on here.","group":"bot","emoji":"🎉","module":"engagement","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"feature","label":"Feature","type":"enum","required":true,"help":"","choices":[{"value":"polls","label":"Polls"},{"value":"suggestions","label":"Suggestion board"},{"value":"reminders","label":"Reminders"},{"value":"tags","label":"Tags / custom commands"},{"value":"starboard","label":"Starboard"},{"value":"tempVoice","label":"Temporary voice rooms"},{"value":"birthdays","label":"Birthdays"}],"min":null,"max":null,"secret":false},{"name":"on","label":"On","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"engagement.content.set","label":"Allow a feature to read messages","help":"Some features cannot work without reading what members type. Each is off in every server until you switch it on here, and switching one off stops it reading at once.","group":"bot","emoji":"⚠️","module":"engagement","permission":"owner","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"feature","label":"Feature","type":"enum","required":true,"help":"","choices":[{"value":"autoresponders","label":"Autoresponders"},{"value":"highlights","label":"Keyword highlights"},{"value":"starboard.text","label":"Starboard — quote the starred message"},{"value":"translation","label":"Message translation"},{"value":"bumps.detect","label":"Bump reminders — detect the bump automatically"}],"min":null,"max":null,"secret":false},{"name":"on","label":"Allow it","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"poll.show","label":"Show a poll","help":"One poll with its options, its running vote totals and whether it is still open.","group":"bot","emoji":"🔎","module":"engagement","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"poll","label":"Poll number","type":"count","required":true,"help":"","choices":null,"min":1,"max":null,"secret":false}]},
    ...
    {"id":"tag.delete","label":"Delete a tag","help":"Removes a canned response so nobody can summon it again. Messages already posted with it stay.","group":"bot","emoji":"🗑️","module":"engagement","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"name","label":"Name","type":"string","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"tempvoice.sweep","label":"Sweep empty rooms","help":"Delete temporary voice rooms that have been empty long enough, and forget any that no longer exist. Run it after a restart if empty rooms have been left behind.","group":"bot","emoji":"🧹","module":"temp-voice","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageChannels"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[]},
    ...
    {"id":"reminder.list","label":"Reminders","help":"Every reminder waiting in this server, or just one member’s, with the number needed to cancel it.","group":"members","emoji":"⏰","module":"reminders","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"member","label":"Member","type":"member","required":false,"help":"Leave blank for everybody's.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"reminder.cancel","label":"Cancel a reminder","help":"Removes a reminder somebody set, so it never fires. Reminders lists the numbers.","group":"members","emoji":"🚫","module":"reminders","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"reminder","label":"Reminder number","type":"count","required":true,"help":"","choices":null,"min":1,"max":null,"secret":false}]},
    ...
    {"id":"levels.reward.list","label":"Role rewards","help":"The whole ladder: which level grants which role, in order, and how many rungs it has.","group":"bot","emoji":"📋","module":"leveling-pro","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    ...
    {"id":"levels.multiplier","label":"XP multiplier","help":"Make a role or a channel earn more or less XP than normal — 1.5 for boosters, 2 for a channel that should count double. Set it to 1 to remove the multiplier.","group":"bot","emoji":"⚖️","module":"leveling-pro","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"kind","label":"On a","type":"enum","required":true,"help":"","choices":[{"value":"role","label":"Role"},{"value":"channel","label":"Channel"}],"min":null,"max":null,"secret":false},{"name":"id","label":"Role or channel id","type":"string","required":true,"help":"Turn on Discord’s Developer Mode, then right-click the role or channel and Copy ID.","choices":null,"min":null,"max":null,"secret":false},{"name":"value","label":"Multiplier","type":"number","required":true,"help":"2 doubles the XP earned there, 0.5 halves it, and 1 removes the multiplier.","choices":null,"min":1,"max":10,"secret":false}]},
    {"id":"levels.noxp","label":"No-XP channel or role","help":"Stop a channel or a role earning XP at all. Use it for bot-spam and command channels, where messages should not count towards levels.","group":"bot","emoji":"🚫","module":"leveling-pro","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"kind","label":"On a","type":"enum","required":true,"help":"","choices":[{"value":"channel","label":"Channel"},{"value":"role","label":"Role"}],"min":null,"max":null,"secret":false},{"name":"id","label":"Channel or role id","type":"string","required":true,"help":"Turn on Discord’s Developer Mode, then right-click the channel or role and Copy ID.","choices":null,"min":null,"max":null,"secret":false},{"name":"on","label":"Blocked","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"levels.rules","label":"XP rules","help":"Every XP multiplier and every channel or role that earns nothing, in one place. Read-only.","group":"bot","emoji":"📐","module":"leveling-pro","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"levels.message","label":"Level-up message","help":"The message posted when somebody levels up. Tokens: {user} {mention} {level} {rank} {server} {xp} {prestige}. Leave it blank to restore the default wording.","group":"bot","emoji":"📣","module":"leveling-pro","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"template","label":"Message","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"levels.message.every","label":"Announce every level","help":"Off announces a level-up only when a member reaches a new rank. On announces every single level, which is much louder in a busy server.","group":"bot","emoji":"🔔","module":"leveling-pro","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"on","label":"Every level","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"levels.import.mee6","label":"Import levels from MEE6","help":"Paste MEE6’s leaderboard export and it raises members to the levels it lists. Levels only ever go UP — but the import itself cannot be undone.","group":"bot","emoji":"📥","module":"level-import","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"payload","label":"MEE6 leaderboard JSON","type":"string","required":true,"help":"The whole JSON document from MEE6’s leaderboard export, pasted in as it came.","choices":null,"min":null,"max":null,"secret":false},{"name":"membersOnly","label":"Skip people who have left","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"levels.import.arcane","label":"Import levels from Arcane (roles)","help":"Arcane publishes no export, so this reads the rank ROLES it assigned. Map one role to one level at a time; applying it cannot be undone.","group":"bot","emoji":"🔮","module":"level-import","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"role","label":"Arcane rank role","type":"role","required":true,"help":"One of the rank roles Arcane assigned. Repeat this control for each further rank.","choices":null,"min":null,"max":null,"secret":false},{"name":"level","label":"The level it represents","type":"count","required":true,"help":"","choices":null,"min":1,"max":100,"secret":false}]},
    ...
    {"id":"shop.grant","label":"Shop — give an item","help":"Hand a member an item for free. Prizes, apologies, compensation.","group":"bot","emoji":"🎁","module":"economy","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"sku","label":"Item id","type":"string","required":true,"help":"The item id, as listed by Shop — what is for sale.","choices":null,"min":null,"max":null,"secret":false},{"name":"qty","label":"How many","type":"count","required":false,"help":"","choices":null,"min":1,"max":null,"secret":false}]},
    {"id":"shop.revoke","label":"Shop — take an item back","help":"Remove an item from a member. No refund — use Economy → Grant if they should be paid back.","group":"bot","emoji":"↩️","module":"economy","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"sku","label":"Item id","type":"string","required":true,"help":"The item id, as listed by Shop — what is for sale.","choices":null,"min":null,"max":null,"secret":false},{"name":"qty","label":"How many","type":"count","required":false,"help":"","choices":null,"min":1,"max":null,"secret":false}]},
    ...
    {"id":"automod.show","label":"AutoMod","help":"Every filtering rule this server has, whether Discord is actually enforcing it, and what is ignored. The filtering runs inside Discord — this bot does not read your members' messages.","group":"guild","emoji":"🛡️","module":"automod","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"automod.master","label":"AutoMod — master switch","help":"Turn the whole rules engine on or off without losing the rules. Switching it off here does NOT remove the rules from Discord — run **Sync rules** after, which is what actually takes them down.","group":"guild","emoji":"🎚️","module":"automod","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"enabled","label":"AutoMod on","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.recommended","label":"AutoMod — apply the recommended rules","help":"A starter rule set for slurs, cuss words, sexual content, spam, mention pile-ons and invite links, all enforced by Discord itself. It alerts staff and deletes nothing unless you say so. Running it twice changes nothing.","group":"guild","emoji":"🌱","module":"automod","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"consequence","label":"What should happen","type":"enum","required":false,"help":"Applies to every rule this creates. Change any of them afterwards with **add or edit a rule**.","choices":[{"value":"alert","label":"Tell staff — the message stays up (recommended)"},{"value":"block","label":"Block the message"},{"value":"block-alert","label":"Block the message and tell staff"},{"value":"block-timeout","label":"Block the message and time the member out"}],"min":null,"max":null,"secret":false},{"name":"alertChannel","label":"Staff alert channel","type":"channel","required":false,"help":"Needed by anything that tells staff. Alerts quote the message, so pick a staff-only channel.","choices":null,"min":null,"max":null,"secret":false},{"name":"timeout","label":"Timeout length","type":"duration","required":false,"help":"Only for the timeout consequence — e.g. 10m, 1h. Max 28d.","choices":null,"min":null,"max":null,"secret":false},{"name":"mentions","label":"Mentions that count as spam","type":"count","required":false,"help":"Default 6.","choices":null,"min":1,"max":50,"secret":false},{"name":"lists","label":"Which of Discord's word lists","type":"pattern","required":false,"help":"slurs, profanity, sexual — comma separated. All three by default, sharing one Discord rule.","choices":null,"min":null,"max":null,"secret":false},{"name":"only","label":"Only these rules","type":"pattern","required":false,"help":"Comma separated: discord-lists, spam, mention-spam, invites, links. Blank = the recommended set.","choices":null,"min":null,"max":null,"secret":false},{"name":"allowDomains","label":"Domains the link rule allows","type":"pattern","required":false,"help":"Only used if you ask for the `links` rule. With none listed it matches EVERY link.","choices":null,"min":null,"max":null,"secret":false},{"name":"force","label":"Replace rules I have already changed","type":"boolean","required":false,"help":"By default a rule whose key already exists is left exactly as you set it.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.rule.set","label":"AutoMod — add or edit a rule","help":"Create a filtering rule, or replace one with the same key. Most kinds are compiled into Discord's own AutoMod and enforced server-side before the bot sees anything.","group":"guild","emoji":"➕","module":"automod","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"key","label":"Key","type":"string","required":true,"help":"A short stable name, e.g. invites or slurs. Changing it makes a NEW rule; the label is free.","choices":null,"min":null,"max":null,"secret":false},{"name":"kind","label":"What it catches","type":"enum","required":true,"help":"","choices":[{"value":"word","label":"Word / phrase filter"},{"value":"regex","label":"Pattern filter"},{"value":"invite","label":"Discord invite blocking"},{"value":"link","label":"Link allowlist"},{"value":"mention","label":"Mention spam"},{"value":"preset","label":"Discord's word presets"},{"value":"spam","label":"Discord's spam detector"},{"value":"caps","label":"Shouting (capitals) (approximate)"},{"value":"zalgo","label":"Zalgo / combining marks (approximate)"},{"value":"emoji","label":"Emoji spam (approximate)"},{"value":"repeat","label":"Repeated text (not enforced by Discord)"},{"value":"attachment","label":"Attachment types (not enforced by Discord)"}],"min":null,"max":null,"secret":false},{"name":"label","label":"Label","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"terms","label":"Words / extensions","type":"pattern","required":false,"help":"Comma or newline separated. `*cat*` matches anywhere.","choices":null,"min":null,"max":null,"secret":false},{"name":"patterns","label":"Patterns","type":"pattern","required":false,"help":"One per line. Discord uses RE2 — no lookaround, no backreferences.","choices":null,"min":null,"max":null,"secret":false},{"name":"allow","label":"Allow list","type":"pattern","required":false,"help":"Domains or words that are always let through.","choices":null,"min":null,"max":null,"secret":false},{"name":"limit","label":"Threshold","type":"count","required":false,"help":"Mentions, emoji, repeats, or a percentage for caps/zalgo.","choices":null,"min":1,"max":null,"secret":false},{"name":"presets","label":"Discord presets","type":"pattern","required":false,"help":"profanity, sexual, slurs — comma separated.","choices":null,"min":null,"max":null,"secret":false},{"name":"action","label":"What to do","type":"enum","required":false,"help":"","choices":[{"value":"block","label":"Block the message"},{"value":"alert","label":"Block it and post an alert to a channel"},{"value":"notify","label":"Post an alert and let the message stand"},{"value":"timeout","label":"Block it and time the member out"}],"min":null,"max":null,"secret":false},{"name":"duration","label":"Timeout length","type":"duration","required":false,"help":"For the timeout action — e.g. 10m, 1h. Max 28d.","choices":null,"min":null,"max":null,"secret":false},{"name":"alertChannel","label":"Alert channel","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"enabled","label":"Enabled","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false}]},
    {"id":"automod.rule.remove","label":"AutoMod — remove a rule","help":"Delete one rule. It stays live at Discord until the next sync, which is said in the result rather than left to be discovered.","group":"guild","emoji":"➖","module":"automod","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"key","label":"Rule key","type":"string","required":true,"help":"The rule key exactly as it appears in AutoMod.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.exempt","label":"AutoMod — ignored roles and channels","help":"Roles and channels every rule ignores. Discord applies these itself, inside each rule, so the exemption is enforced in the same place the rule is.","group":"guild","emoji":"🙈","module":"automod","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"kind","label":"Ignore what","type":"enum","required":true,"help":"","choices":[{"value":"roles","label":"Role"},{"value":"channels","label":"Channel"}],"min":null,"max":null,"secret":false},{"name":"id","label":"Its id","type":"string","required":true,"help":"Turn on Discord’s Developer Mode, then right-click the role or channel and Copy ID.","choices":null,"min":null,"max":null,"secret":false},{"name":"remove","label":"Remove it from the list instead","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.sync","label":"AutoMod — sync rules to Discord","help":"Create, update and remove the Discord AutoMod rules that match your rule set. Rules you made yourself are never touched. The dry run shows exactly what would change.","group":"guild","emoji":"🔄","module":"automod","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageGuild"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[]},
    {"id":"automod.content","label":"AutoMod — what reads your messages","help":"Exactly which parts of moderation can read message content, which cannot, and what each one uses instead. Everything that reads content is off unless you switched it on.","group":"guild","emoji":"🔒","module":"automod","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"automod.content.set","label":"AutoMod — allow a message-content refinement","help":"Switch on one of the refinements that has to read what members typed. Each has a server-side alternative that reads nothing; switching one off stops it reading at once.","group":"guild","emoji":"⚠️","module":"automod","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"feature","label":"Which refinement","type":"enum","required":true,"help":"","choices":[{"value":"automod.caps","label":"Shouting filter — exact capital ratio"},{"value":"automod.zalgo","label":"Zalgo filter — exact combining-mark ratio"},{"value":"automod.emoji","label":"Emoji-spam filter — exact count"},{"value":"automod.repeat","label":"Repeated-text filter"},{"value":"automod.attachment","label":"Attachment-type filter"}],"min":null,"max":null,"secret":false},{"name":"on","label":"Allow it","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.phishing","label":"AutoMod — scam link blocklist","help":"Block known scam and phishing domains. Paste a list, or leave it blank to see the current one. The list is compiled into Discord's own AutoMod, so no message is ever read.","group":"guild","emoji":"🎣","module":"automod","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"enabled","label":"Blocklist on","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"list","label":"Domains","type":"pattern","required":false,"help":"One per line. Bare domains, URLs, hosts lines and adblock syntax all work; # is a comment.","choices":null,"min":null,"max":null,"secret":false},{"name":"source","label":"Where it came from","type":"string","required":false,"help":"Recorded so somebody can tell where the list is maintained.","choices":null,"min":null,"max":null,"secret":false},{"name":"force","label":"Accept a much smaller list","type":"boolean","required":false,"help":"A big drop usually means a failed download, so it is refused unless you say otherwise.","choices":null,"min":null,"max":null,"secret":false},{"name":"check","label":"Test a domain","type":"string","required":false,"help":"Would this domain be blocked? Nothing is changed.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.raid","label":"Anti-raid","help":"Detects a burst of joins from new accounts and responds on its own — it can lock the server down, raise the verification level and pause invites without asking you first.","group":"guild","emoji":"🚨","module":"automod","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"enabled","label":"Detection on","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"joins","label":"Joins that count as a burst","type":"count","required":false,"help":"","choices":null,"min":2,"max":500,"secret":false},{"name":"window","label":"In how long","type":"duration","required":false,"help":"e.g. 60s, 5m.","choices":null,"min":null,"max":null,"secret":false},{"name":"youngShare","label":"Minimum % of new accounts","type":"count","required":false,"help":"Below this it is treated as attention, not an attack.","choices":null,"min":0,"max":100,"secret":false},{"name":"alertChannel","label":"Alert channel","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"lockdown","label":"Lock the server down","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"raiseVerification","label":"Raise the verification level","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"pauseInvites","label":"Pause invites","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false}]},
    {"id":"automod.raid.status","label":"Anti-raid — status and recovery","help":"What the join-velocity detector currently sees, and the list of everyone who arrived in a window — the list to feed to **Mass ban**, which counts before it acts.","group":"guild","emoji":"📈","module":"automod","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"minutes","label":"Look back how many minutes","type":"count","required":false,"help":"","choices":null,"min":1,"max":1440,"secret":false},{"name":"onlyNew","label":"Only brand-new accounts","type":"boolean","required":false,"help":"Uses the young-account threshold from Anti-raid.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.slowmode","label":"Slowmode on a spike","help":"Set slowmode automatically when a channel suddenly speeds up, and put the channel's own previous slowmode back when it calms down.","group":"guild","emoji":"🐌","module":"automod","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"enabled","label":"On","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"messages","label":"Messages that count as a spike","type":"count","required":false,"help":"","choices":null,"min":5,"max":1000,"secret":false},{"name":"window","label":"In how long","type":"duration","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"seconds","label":"Slowmode to set (seconds)","type":"count","required":false,"help":"","choices":null,"min":1,"max":21600,"secret":false},{"name":"hold","label":"Keep it on for at least","type":"duration","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.escalation","label":"Escalation ladder","help":"Automatic consequences as a member accumulates cases — 3 warns → time out, 5 → kick, 7 → ban. Configurable per offence, and only cases inside the window count.","group":"members","emoji":"🪜","module":"modlog","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"key","label":"Ladder key","type":"string","required":true,"help":"e.g. `warnings`. One ladder per kind of offence.","choices":null,"min":null,"max":null,"secret":false},{"name":"enabled","label":"Ladder on","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"counts","label":"Which case types count","type":"pattern","required":false,"help":"e.g. `warn` — comma separated.","choices":null,"min":null,"max":null,"secret":false},{"name":"window","label":"Only count cases from the last","type":"duration","required":false,"help":"e.g. 90d. A warning from two years ago should not stack with today's.","choices":null,"min":null,"max":null,"secret":false},{"name":"rungs","label":"The rungs","type":"pattern","required":false,"help":"One per line: `3 timeout 1h`, `5 kick`, `7 ban`.","choices":null,"min":null,"max":null,"secret":false},{"name":"remove","label":"Delete this ladder instead","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.escalation.check","label":"Escalation — what happens next","help":"Where a member stands on each ladder, and exactly what their next offence triggers. This is the sentence to put in a warning.","group":"members","emoji":"🔎","module":"modlog","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.tempban","label":"Temporary ban","help":"Ban a member for a set time. ⚠ The unban is NOT automatic — the ban is recorded and listed under Expiring punishments, and somebody has to lift it there.","group":"members","emoji":"⏳","module":"modlog","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["BanMembers"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"duration","label":"How long","type":"duration","required":true,"help":"e.g. 3d, 12h.","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"purgeDays","label":"Delete their last N days of messages","type":"count","required":false,"help":"","choices":null,"min":0,"max":7,"secret":false}]},
    {"id":"automod.temprole","label":"Temporary role","help":"Give a member a role for a set time. ⚠ Taking it back is NOT automatic — it is recorded and listed under Expiring punishments for somebody to remove there.","group":"members","emoji":"🏷️","module":"modlog","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageRoles"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"role","label":"Role","type":"role","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"duration","label":"How long","type":"duration","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.quarantine","label":"Quarantine","help":"Puts a suspicious account into the quarantine role until staff have looked at it. Everything that role denies applies to them at once. Set the role here once and it is reused.","group":"members","emoji":"🚧","module":"modlog","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageRoles"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"Member","type":"member","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"duration","label":"For how long","type":"duration","required":false,"help":"Leave blank for the default of 24 hours.","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"role","label":"Set the quarantine role","type":"role","required":false,"help":"Configures the role and does nothing else.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.expiring","label":"Expiring punishments","help":"Every temporary ban, temporary role and quarantine still outstanding, and which of them are due. Nothing lifts itself, so this list is how they get lifted.","group":"members","emoji":"📋","module":"modlog","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"automod.lift","label":"Lift a temporary punishment","help":"Undo one temporary ban, role or quarantine and mark it lifted. Lifting something already lifted is harmless and says so.","group":"members","emoji":"🕊️","module":"modlog","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["BanMembers","ManageRoles"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"key","label":"Which one","type":"string","required":true,"help":"The key from **Expiring punishments**, e.g. `tempban:12345:-`.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.massban","label":"Mass ban from a list","help":"Ban everyone in a pasted list of ids. It counts first, tells you what it would skip and why, and refuses to ban a moderator or itself.","group":"members","emoji":"🔨","module":"modlog","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["BanMembers"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"list","label":"Ids","type":"pattern","required":true,"help":"One per line, or mentions, or a CSV column. Usernames are not accepted.","choices":null,"min":null,"max":null,"secret":false},{"name":"reason","label":"Reason","type":"reason","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"purgeDays","label":"Delete their last N days of messages","type":"count","required":false,"help":"","choices":null,"min":0,"max":7,"secret":false},{"name":"protect","label":"Never ban these ids","type":"pattern","required":false,"help":"In addition to this bot itself.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.appeals","label":"Appeals","help":"Let members appeal a case through a ticket. Needs the ticket system configured — a banned member cannot open a ticket here, so an appeal-server invite is what makes ban appeals reachable at all.","group":"members","emoji":"⚖️","module":"modlog","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"enabled","label":"Appeals on","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"category","label":"Ticket category key","type":"string","required":false,"help":"From **Tickets → Categories**.","choices":null,"min":null,"max":null,"secret":false},{"name":"appealable","label":"Which case types can be appealed","type":"pattern","required":false,"help":"Comma separated, e.g. `warn, timeout, ban`.","choices":null,"min":null,"max":null,"secret":false},{"name":"window","label":"Appeal within","type":"duration","required":false,"help":"e.g. 30d. Staff cannot answer questions about decisions nobody remembers.","choices":null,"min":null,"max":null,"secret":false},{"name":"cooldown","label":"Wait this long after a refusal","type":"duration","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"maxPerCase","label":"Attempts per case","type":"count","required":false,"help":"","choices":null,"min":1,"max":10,"secret":false},{"name":"invite","label":"Appeal-server invite","type":"string","required":false,"help":"Where a banned member goes, since they cannot open a ticket in this server.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.appeal.list","label":"Appeals — list","help":"Appeals waiting for a staff answer, or every appeal about one case or one member.","group":"members","emoji":"📥","module":"modlog","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"case","label":"About case number","type":"count","required":false,"help":"","choices":null,"min":1,"max":null,"secret":false},{"name":"member","label":"From member","type":"member","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"openOnly","label":"Only ones awaiting an answer","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"automod.appeal.decide","label":"Appeals — decide","help":"Records a verdict on an appeal. It never unbans anybody by itself: it tells you what the verdict implies and you press the buttons.","group":"members","emoji":"⚖️","module":"modlog","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"appeal","label":"Appeal number","type":"count","required":true,"help":"","choices":null,"min":1,"max":null,"secret":false},{"name":"verdict","label":"Verdict","type":"enum","required":true,"help":"","choices":[{"value":"accepted","label":"Accepted"},{"value":"reduced","label":"Reduced"},{"value":"rejected","label":"Rejected"},{"value":"withdrawn","label":"Withdrawn"}],"min":null,"max":null,"secret":false},{"name":"note","label":"Note to the member","type":"reason","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"serverlog.show","label":"Staff logging","help":"What this server's staff log holds, how long it holds it, and what it deliberately does not hold.","group":"guild","emoji":"🗒️","module":"logging","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"serverlog.content","label":"Staff logging — message content","help":"Why the edit/delete log shows who and where but not what was said, what it would cost to change that, and what you get instead.","group":"guild","emoji":"📖","module":"logging","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"serverlog.retention","label":"Staff logging — records & retention","help":"Hold a short metadata record of each message so a deletion can name its author. No message text is ever held. Set how long, and how much.","group":"guild","emoji":"⏳","module":"logging","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"enabled","label":"Hold message records","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"hours","label":"Keep for (hours)","type":"number","required":false,"help":"","choices":null,"min":0.016666666666666666,"max":24,"secret":false},{"name":"perChannel","label":"Max per channel","type":"count","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"perGuild","label":"Max for the whole server","type":"count","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"serverlog.forget","label":"Staff logging — erase a member's records","help":"Delete everything the staff log holds about one member: their message records and their invite attributions, in both directions.","group":"guild","emoji":"🧹","module":"logging","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"serverlog.invites","label":"Invite tracking","help":"Attribute each join to the invite that was used, and show who has brought the most people in. Turn it on, or read the board.","group":"guild","emoji":"🎟️","module":"logging","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"enabled","label":"Track who invited whom","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"top","label":"Show the top N","type":"count","required":false,"help":"Leave blank to just read the current board.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"serverlog.noise","label":"Staff logging — noise filters","help":"The filters that decide whether the role and channel feeds are readable. Both default to ON, and turning either off will make the log much louder.","group":"guild","emoji":"🔇","module":"logging","permission":"admin","destructive":false,"confirm":false,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"filter","label":"Which filter","type":"enum","required":true,"help":"","choices":[{"value":"botActor","label":"Hide changes the bot itself made"},{"value":"managedRoles","label":"Hide boost / bot / Twitch role changes"}],"min":null,"max":null,"secret":false},{"name":"on","label":"Keep it filtered","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"serverlog.archive","label":"Bulk-delete archive","help":"Export a record of the messages currently held for one channel: who posted, when, how long each was, and what was attached. No message text.","group":"guild","emoji":"🗂️","module":"logging","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"channel","label":"Channel","type":"channel","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"mode","label":"What goes in the file","type":"enum","required":false,"help":"Metadata is the only mode that works — the content mode is listed but refused.","choices":[{"value":"metadata","label":"The purge record — who, where, how many, and each message's shape"},{"value":"full","label":"🚫 Everything above, plus the text of the deleted messages"}],"min":null,"max":null,"secret":false}]},
    {"id":"serverlog.preview","label":"Staff logging — preview an entry","help":"Show what a join, a role change, a voice move or a channel edit would look like and where it would go — including the reason it would go nowhere.","group":"guild","emoji":"🔎","module":"logging","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"kind","label":"Which kind of entry","type":"enum","required":true,"help":"","choices":[{"value":"join","label":"A member joining (account age + invite)"},{"value":"leave","label":"A member leaving"},{"value":"roles","label":"A role change"},{"value":"nick","label":"A nickname change"},{"value":"voice","label":"A voice move"},{"value":"channel","label":"A channel being renamed"}],"min":null,"max":null,"secret":false},{"name":"byBot","label":"Pretend the bot made the change","type":"boolean","required":false,"help":"To see the noise filter refuse it.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"verify.status","label":"Verification — status","help":"The verification gate at a glance: which strategy is set, whether it can actually be enforced, how many members are waiting, and how strong it really is.","group":"members","emoji":"🚪","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"verify.setup","label":"Verification — set up","help":"Strategy, roles, the one channel unverified members see, and how they prove themselves.","group":"members","emoji":"🛠️","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"strategy","label":"Strategy","type":"enum","required":false,"help":"","choices":[{"value":"grant-access","label":"Grant access on verify (recommended — fails CLOSED)"},{"value":"quarantine-role","label":"Quarantine role on join (⚠ fails OPEN — needs a backstop)"}],"min":null,"max":null,"secret":false},{"name":"role","label":"Verified or quarantine role","type":"role","required":false,"help":"Which of the two it means depends on the strategy above.","choices":null,"min":null,"max":null,"secret":false},{"name":"channel","label":"Verification channel","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"alertChannel","label":"Alert channel","type":"channel","required":false,"help":"Where the bot warns you when the gate cannot be enforced.","choices":null,"min":null,"max":null,"secret":false},{"name":"method","label":"How they verify","type":"enum","required":false,"help":"","choices":[{"value":"button","label":"Button press"},{"value":"image","label":"Image challenge (harder for scripts, still not a captcha)"}],"min":null,"max":null,"secret":false},{"name":"backstop","label":"If quarantine fails","type":"enum","required":false,"help":"","choices":[{"value":"timeout","label":"Time them out (recommended — reversible)"},{"value":"kick","label":"Kick them (most closed, least recoverable)"},{"value":"alert-only","label":"⚠ Alert only — they stay in, unverified"}],"min":null,"max":null,"secret":false}]},
    {"id":"verify.arm","label":"Verification — arm / disarm","help":"Switches the gate on or off. Arming it starts holding every new member until they verify; disarming stops the gate immediately.","group":"members","emoji":"🔒","module":"verification","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageRoles"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"on","label":"On or off","type":"enum","required":true,"help":"","choices":[{"value":"on","label":"Arm the gate"},{"value":"off","label":"Disarm"}],"min":null,"max":null,"secret":false}]},
    {"id":"verify.panel","label":"Verification — post the panel","help":"Post (or refresh) the card an unverified member presses.","group":"members","emoji":"📌","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["ViewChannel","SendMessages"],"mode":"all","scope":"channel","param":"channel","hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"channel","label":"Channel","type":"channel","required":false,"help":"Leave blank to post in the verification channel.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"verify.sweep","label":"Verification — who slipped in","help":"Members the gate never saw — usually because they joined while the bot was offline.","group":"members","emoji":"🔍","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"limit","label":"How many to list","type":"count","required":false,"help":"","choices":null,"min":1,"max":50,"secret":false}]},
    {"id":"verify.member","label":"Verification — verify or reset a member","help":"Pushes somebody through the gate by hand, or sends them back to it. Sending them back removes their verified role until they pass again.","group":"members","emoji":"✅","module":"verification","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageRoles"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"action","label":"What to do","type":"enum","required":true,"help":"","choices":[{"value":"verify","label":"Verify them"},{"value":"reset","label":"Send them back to the gate"}],"min":null,"max":null,"secret":false}]},
    {"id":"verify.age","label":"Minimum account age (standing)","help":"A standing floor on how old a Discord account must be to get in. Unlike raid mode it is always on, and it can gate, time out or kick every account under the limit.","group":"members","emoji":"🕰️","module":"verification","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"on","label":"On or off","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"minDays","label":"Minimum account age in days","type":"count","required":false,"help":"","choices":null,"min":1,"max":3650,"secret":false},{"name":"action","label":"What to do with a younger account","type":"enum","required":false,"help":"","choices":[{"value":"gate","label":"Hold them at the verification gate (recommended)"},{"value":"timeout","label":"Time them out"},{"value":"kick","label":"Kick them"},{"value":"flag","label":"Just tell staff"}],"min":null,"max":null,"secret":false},{"name":"timeout","label":"Timeout length","type":"duration","required":false,"help":"Used when the action is “time them out”. Max 28d.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"verify.rules","label":"Rules acceptance gate","help":"Make members accept your rules before they get in. Editing the text records a new version — turn on re-gate below to send everyone who already accepted back through it.","group":"members","emoji":"📜","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"on","label":"On or off","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"text","label":"The rules","type":"string","required":false,"help":"The rules members must accept. Leave blank to read the current text without changing it.","choices":null,"min":null,"max":null,"secret":false},{"name":"regate","label":"⚠ Re-gate everyone when the rules change","type":"enum","required":false,"help":"","choices":[{"value":"off","label":"No (recommended)"},{"value":"on","label":"Yes — un-verify everyone on every edit"}],"min":null,"max":null,"secret":false}]},
    {"id":"verify.question.set","label":"Onboarding question — add or edit","help":"Ask a question on the way in and grant a role from the answer.","group":"members","emoji":"🧭","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"key","label":"Key","type":"string","required":true,"help":"Lower-case, e.g. platform.","choices":null,"min":null,"max":null,"secret":false},{"name":"prompt","label":"The question","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"choice","label":"Choice label","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"role","label":"Role this choice grants","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"multi","label":"Answers","type":"enum","required":false,"help":"","choices":[{"value":"single","label":"Pick one"},{"value":"multi","label":"Pick several"}],"min":null,"max":null,"secret":false},{"name":"on","label":"Questions on or off","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false}]},
    {"id":"verify.question.remove","label":"Onboarding question — remove","help":"Delete an onboarding question. Roles already granted are untouched.","group":"members","emoji":"🧹","module":"verification","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"key","label":"Key","type":"string","required":true,"help":"The key you gave the question when you added it.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"verify.welcome","label":"Welcome image","help":"A rendered card when somebody joins. Placeholders: {user} {username} {server} {count}.","group":"members","emoji":"🖼️","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"on","label":"On or off","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"channel","label":"Channel","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"title","label":"Big word (e.g. WELCOME)","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"line","label":"The line underneath","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"accent","label":"Accent colour","type":"string","required":false,"help":"#rrggbb.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"verify.render.check","label":"Render check (fonts)","help":"Renders the welcome card and the verification image, then reports whether the text came out readable. Run it after changing fonts or artwork. Nothing is posted.","group":"members","emoji":"🔤","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"verify.application.set","label":"Application form — add or edit","help":"A staff/whitelist application. Uses the ticket system's form machinery, and a ticket channel when you have one.","group":"members","emoji":"📝","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"key","label":"Key","type":"string","required":true,"help":"A short lower-case id for this form, e.g. staff. You reuse it to open, close or remove it.","choices":null,"min":null,"max":null,"secret":false},{"name":"label","label":"What it is called","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"question","label":"Add a question","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"paragraph","label":"That question wants a long answer","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"reviewChannel","label":"Where submissions are reviewed","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"reviewerRole","label":"Who reviews them","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"ticketCategory","label":"Ticket category to open (optional)","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"on","label":"Applications on or off","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false}]},
    {"id":"verify.application.open","label":"Application form — open or close","help":"Start or stop accepting submissions for one form.","group":"members","emoji":"🔓","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"key","label":"Key","type":"string","required":true,"help":"The key you gave the form when you created it.","choices":null,"min":null,"max":null,"secret":false},{"name":"state","label":"Open or closed","type":"enum","required":true,"help":"","choices":[{"value":"open","label":"Open — accepting"},{"value":"closed","label":"Closed"}],"min":null,"max":null,"secret":false}]},
    {"id":"verify.application.remove","label":"Application form — remove","help":"Delete an application form. Submissions already made are not touched.","group":"members","emoji":"🗑️","module":"verification","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"key","label":"Key","type":"string","required":true,"help":"The key you gave the form when you created it.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"social.status","label":"Social alerts — status","help":"Which services are ready, which need a credential, what each feed has announced, and anything that may not have been delivered. Reads only.","group":"bot","emoji":"📡","module":"social-alerts","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"social.setup","label":"Social alerts — on/off and defaults","help":"The master switch, the default channel and the default ping role. Turning it off holds every feed without losing what has already been announced.","group":"bot","emoji":"🎚️","module":"social-alerts","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"on","label":"Social alerts on","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"channel","label":"Default channel for new feeds","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"role","label":"Default ping role for new feeds","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"maxfeeds","label":"Maximum feeds for this server","type":"count","required":false,"help":"","choices":null,"min":1,"max":100,"secret":false}]},
    {"id":"social.feed.add","label":"Social alerts — watch something","help":"A Twitch channel going live, a YouTube channel uploading, a subreddit posting, or any RSS/Atom feed. The first poll records what is already there and announces none of it.","group":"bot","emoji":"➕","module":"social-alerts","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["ViewChannel","SendMessages"],"mode":"all","scope":"channel","param":"channel","hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"service","label":"Service","type":"enum","required":true,"help":"","choices":[{"value":"twitch","label":"🟣 Twitch"},{"value":"youtube","label":"🔴 YouTube"},{"value":"reddit","label":"🟠 Reddit"},{"value":"rss","label":"📰 RSS / Atom"},{"value":"kick","label":"🟩 Kick — not supported"},{"value":"tiktok","label":"⬛ TikTok — not supported"},{"value":"twitter","label":"⬜ X / Twitter — not supported"}],"min":null,"max":null,"secret":false},{"name":"target","label":"Who or what to watch","type":"string","required":true,"help":"A Twitch or YouTube channel name, a subreddit, or the full address of an RSS feed.","choices":null,"min":null,"max":null,"secret":false},{"name":"channel","label":"Post alerts in","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"role","label":"Ping this role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"name","label":"A name for this feed (optional)","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"template","label":"Message template (blank = the default)","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"social.feed.list","label":"Social alerts — what is being watched","help":"Every feed, where it posts, what it pings and how often it is checked.","group":"bot","emoji":"📋","module":"social-alerts","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"social.feed.edit","label":"Social alerts — edit a feed","help":"Change where it posts, what it pings, its message template, how often it is checked, or switch it off. The target itself cannot be changed — remove and re-add for that.","group":"bot","emoji":"✏️","module":"social-alerts","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"feed","label":"Feed number","type":"count","required":true,"help":"","choices":null,"min":1,"max":null,"secret":false},{"name":"channel","label":"Post alerts in","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"role","label":"Ping this role (blank clears it)","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"template","label":"Message template","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"every","label":"How often to check","type":"duration","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"on","label":"Feed on","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"social.feed.remove","label":"Social alerts — stop watching","help":"Removes the feed and its record of what has already been announced.","group":"bot","emoji":"🗑️","module":"social-alerts","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"feed","label":"Feed number","type":"count","required":true,"help":"","choices":null,"min":1,"max":null,"secret":false}]},
    {"id":"social.poll","label":"Social alerts — check now","help":"Polls every feed that is due and posts anything new. Preview first to see what WOULD be posted without posting it or marking anything as announced.","group":"bot","emoji":"🔄","module":"social-alerts","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"preview","label":"Preview only — post nothing","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"all","label":"Check every feed","type":"boolean","required":false,"help":"Not just the ones whose next check is due.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"social.unconfirmed","label":"Social alerts — possibly-missed alerts","help":"Alerts this bot decided to send and never confirmed sending — a restart at exactly the wrong moment. They are never retried, because retrying is how an alert posts twice.","group":"bot","emoji":"❓","module":"social-alerts","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"provision.show","label":"Channel wiring — what points where","help":"Every module setting that holds a channel or category: what it points at, whether that channel still exists, and what is not set. A pointer whose channel was deleted is reported as dangling, never counted as configured.","group":"channels","emoji":"🔌","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"target","label":"One target only","type":"enum","required":false,"help":"Leave blank for all of them.","choices":[{"value":"modlog.default","label":"Staff log — default channel"},{"value":"modlog.event","label":"Staff log — one event’s own channel"},{"value":"tickets.parent","label":"Tickets — category new ticket channels are made in"},{"value":"tickets.panel","label":"Tickets — the panel members press"},{"value":"tickets.transcript","label":"Tickets — where closed transcripts are posted"},{"value":"verify.gate","label":"Verification — the channel unverified members see"},{"value":"verify.alert","label":"Verification — where the gate shouts when it cannot hold"},{"value":"suggestions.board","label":"Suggestions — the board"},{"value":"suggestions.decisions","label":"Suggestions — where decisions are announced"},{"value":"starboard.board","label":"Starboard — where starred messages are reposted"},{"value":"birthdays.announce","label":"Birthdays — where the announcement goes"},{"value":"automod.raidAlert","label":"Anti-raid — where the raid alert is posted"},{"value":"automod.ruleAlert","label":"AutoMod rule — where one rule’s alert is posted"},{"value":"social.default","label":"Social alerts — default channel"}],"min":null,"max":null,"secret":false},{"name":"key","label":"Which slot","type":"string","required":false,"help":"Only for the two targets that have more than one slot: a log event id, or an automod rule key.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"provision.point","label":"Channel wiring — point at an existing channel","help":"Point a module at a channel you already have, without copying ids between tabs. The module checks the channel exactly as it would on its own screen, so a bad one is still refused.","group":"channels","emoji":"🎯","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"target","label":"What to wire up","type":"enum","required":true,"help":"Which module setting to point somewhere. “What points where” lists every one.","choices":[{"value":"modlog.default","label":"Staff log — default channel"},{"value":"modlog.event","label":"Staff log — one event’s own channel"},{"value":"tickets.parent","label":"Tickets — category new ticket channels are made in"},{"value":"tickets.panel","label":"Tickets — the panel members press"},{"value":"tickets.transcript","label":"Tickets — where closed transcripts are posted"},{"value":"verify.gate","label":"Verification — the channel unverified members see"},{"value":"verify.alert","label":"Verification — where the gate shouts when it cannot hold"},{"value":"suggestions.board","label":"Suggestions — the board"},{"value":"suggestions.decisions","label":"Suggestions — where decisions are announced"},{"value":"starboard.board","label":"Starboard — where starred messages are reposted"},{"value":"birthdays.announce","label":"Birthdays — where the announcement goes"},{"value":"automod.raidAlert","label":"Anti-raid — where the raid alert is posted"},{"value":"automod.ruleAlert","label":"AutoMod rule — where one rule’s alert is posted"},{"value":"social.default","label":"Social alerts — default channel"}],"min":null,"max":null,"secret":false},{"name":"channel","label":"Channel (or category)","type":"channel","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"key","label":"Which slot","type":"string","required":false,"help":"Only for the two targets that have more than one slot: a log event id, or an automod rule key.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"provision.create","label":"Channel wiring — create the channel and wire it up","help":"Creates the channel — and the category above it if you want — with the name and visibility you choose, then points the module at it, replacing whatever that setting held. A channel of that name in that parent is reused.","group":"channels","emoji":"🏗️","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageChannels"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"target","label":"What to wire up","type":"enum","required":true,"help":"Which module setting to point at the new channel. “What points where” lists them.","choices":[{"value":"modlog.default","label":"Staff log — default channel"},{"value":"modlog.event","label":"Staff log — one event’s own channel"},{"value":"tickets.parent","label":"Tickets — category new ticket channels are made in"},{"value":"tickets.panel","label":"Tickets — the panel members press"},{"value":"tickets.transcript","label":"Tickets — where closed transcripts are posted"},{"value":"verify.gate","label":"Verification — the channel unverified members see"},{"value":"verify.alert","label":"Verification — where the gate shouts when it cannot hold"},{"value":"suggestions.board","label":"Suggestions — the board"},{"value":"suggestions.decisions","label":"Suggestions — where decisions are announced"},{"value":"starboard.board","label":"Starboard — where starred messages are reposted"},{"value":"birthdays.announce","label":"Birthdays — where the announcement goes"},{"value":"automod.raidAlert","label":"Anti-raid — where the raid alert is posted"},{"value":"automod.ruleAlert","label":"AutoMod rule — where one rule’s alert is posted"},{"value":"social.default","label":"Social alerts — default channel"}],"min":null,"max":null,"secret":false},{"name":"name","label":"Name it","type":"string","required":false,"help":"Leave blank for a sensible default for this target.","choices":null,"min":null,"max":null,"secret":false},{"name":"parent","label":"Put it in this category","type":"category","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"newCategory","label":"…or create a category with this name","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"visibility","label":"Who can see it","type":"enum","required":false,"help":"","choices":[{"value":"default","label":"Use this target’s own default"},{"value":"staff","label":"Staff only — hidden from @everyone"},{"value":"everyone","label":"Everyone — can see it and post in it"},{"value":"announcement","label":"Everyone reads and reacts; only staff and the bot post"},{"value":"role","label":"One role only — it can see and post"},{"value":"private","label":"One role only — hidden and unjoinable to everyone else"}],"min":null,"max":null,"secret":false},{"name":"viewRole","label":"Role that gets access","type":"role","required":false,"help":"Needed by the one-role shapes. Staff-only falls back to every role holding a moderation permission.","choices":null,"min":null,"max":null,"secret":false},{"name":"key","label":"Which slot","type":"string","required":false,"help":"Only for the two targets that have more than one slot: a log event id, or an automod rule key.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"provision.unset","label":"Channel wiring — clear a target","help":"Point a module setting at nothing. The channel itself is not touched — this only removes the pointer, which is what you want for a dangling id whose channel is already gone.","group":"channels","emoji":"🧹","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"target","label":"What to clear","type":"enum","required":true,"help":"Which module setting to empty. “What points where” shows what each holds now.","choices":[{"value":"modlog.default","label":"Staff log — default channel"},{"value":"modlog.event","label":"Staff log — one event’s own channel"},{"value":"tickets.parent","label":"Tickets — category new ticket channels are made in"},{"value":"tickets.panel","label":"Tickets — the panel members press"},{"value":"tickets.transcript","label":"Tickets — where closed transcripts are posted"},{"value":"verify.gate","label":"Verification — the channel unverified members see"},{"value":"verify.alert","label":"Verification — where the gate shouts when it cannot hold"},{"value":"suggestions.board","label":"Suggestions — the board"},{"value":"suggestions.decisions","label":"Suggestions — where decisions are announced"},{"value":"starboard.board","label":"Starboard — where starred messages are reposted"},{"value":"birthdays.announce","label":"Birthdays — where the announcement goes"},{"value":"automod.raidAlert","label":"Anti-raid — where the raid alert is posted"},{"value":"automod.ruleAlert","label":"AutoMod rule — where one rule’s alert is posted"},{"value":"social.default","label":"Social alerts — default channel"}],"min":null,"max":null,"secret":false},{"name":"key","label":"Which slot","type":"string","required":false,"help":"Only for the two targets that have more than one slot: a log event id, or an automod rule key.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"autosetup.preview","label":"Module setup — preview","help":"Works out whether this is an established server or a brand-new one, then shows exactly which channel each module WOULD be wired to — adopting what you already have rather than building a second set. Changes nothing.","group":"settings","emoji":"🧭","module":"admin-console","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"mode","label":"Treat this server as","type":"enum","required":false,"help":"Leave on auto unless the guess is wrong.","choices":[{"value":"auto","label":"Decide from the server itself (recommended)"},{"value":"established","label":"Treat as an established server — adopt only"},{"value":"fresh","label":"Treat as a new server — create everything"}],"min":null,"max":null,"secret":false},{"name":"staffRole","label":"Staff role","type":"role","required":false,"help":"Who can see the staff-only channels. Detected from permissions when blank.","choices":null,"min":null,"max":null,"secret":false},{"name":"createMissing","label":"Also create what is missing","type":"boolean","required":false,"help":"On an established server nothing is created unless you tick this.","choices":null,"min":null,"max":null,"secret":false},{"name":"repair","label":"Repair dangling settings","type":"boolean","required":false,"help":"Move a setting that points at a deleted channel onto a live one.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"autosetup.apply","label":"Module setup — apply","help":"Wires every module to the channels this server already has, and (on a brand-new server) builds the ones it does not. Running it twice changes nothing the second time.","group":"settings","emoji":"🪄","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"mode","label":"Treat this server as","type":"enum","required":false,"help":"Leave it on auto unless the preview guessed this server wrong.","choices":[{"value":"auto","label":"Decide from the server itself (recommended)"},{"value":"established","label":"Treat as an established server — adopt only"},{"value":"fresh","label":"Treat as a new server — create everything"}],"min":null,"max":null,"secret":false},{"name":"staffRole","label":"Staff role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"createMissing","label":"Also create what is missing","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"repair","label":"Repair dangling settings","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"confirm","label":"Yes, I have read the preview","type":"boolean","required":false,"help":"Required on a server that is already in use. A new server does not need it.","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"autosetup.target","label":"Module setup — one setting","help":"Overrules the automatic match for a single setting: point it at the channel, category or role you actually want, or tell setup to stop offering it.","group":"settings","emoji":"🎯","module":"admin-console","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"target","label":"Setting","type":"enum","required":true,"help":"One module setting. “Module setup — preview” lists every one and what it matched.","choices":[{"value":"modlog.channel","label":"Moderation cases · Moderation log"},{"value":"tickets.parent","label":"Tickets · Ticket category"},{"value":"tickets.panel","label":"Tickets · Ticket panel channel"},{"value":"tickets.transcripts","label":"Tickets · Ticket transcripts"},{"value":"verify.channel","label":"Verification · Verification channel"},{"value":"verify.alerts","label":"Verification · Verification alerts"},{"value":"verify.verifiedRole","label":"Verification · Verified role"},{"value":"verify.quarantineRole","label":"Verification · Quarantine role"},{"value":"engagement.suggestions","label":"Engagement · Suggestions"},{"value":"engagement.suggestionDecisions","label":"Engagement · Suggestion decisions"},{"value":"engagement.starboard","label":"Engagement · Starboard"},{"value":"engagement.birthdays","label":"Engagement · Birthdays"},{"value":"automod.raidAlerts","label":"AutoMod · Raid alerts"},{"value":"alerts.default","label":"Social alerts · Social alerts"}],"min":null,"max":null,"secret":false},{"name":"channel","label":"Channel","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"category","label":"Category","type":"category","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"role","label":"Role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"skip","label":"Leave this one alone","type":"boolean","required":false,"help":"Setup stops proposing it. Untick to start again.","choices":null,"min":null,"max":null,"secret":false}]},
  ],
  };
