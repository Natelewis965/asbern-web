...
var AsbernDash = (function () {
  ...
  var REGISTRY = /* ---- GENERATED — 369 actions, 11 groups, fingerprint 8110623f328b7138.
  ...
  actions: [
    ...
    {"id":"serverlog.archive","label":"Bulk-delete archive","help":"Export a record of the messages currently held for one channel: who posted, when, how long each was, and what was attached. No message text.","group":"guild","emoji":"🗂️","module":"logging","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"channel","label":"Channel","type":"channel","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"mode","label":"What goes in the file","type":"enum","required":false,"help":"","choices":[{"value":"metadata","label":"The purge record — who, where, how many, and each message's shape"},{"value":"full","label":"🚫 Everything above, plus the text of the deleted messages"}],"min":null,"max":null,"secret":false}]},
    ...
    {"id":"verify.status","label":"Verification — status","help":"The whole gate at a glance: strategy, readiness, what is holding, and how strong it actually is.","group":"members","emoji":"🚪","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[]},
    {"id":"verify.setup","label":"Verification — set up","help":"Strategy, roles, the one channel unverified members see, and how they prove themselves.","group":"members","emoji":"🛠️","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"strategy","label":"Strategy","type":"enum","required":false,"help":"","choices":[{"value":"grant-access","label":"Grant access on verify (recommended — fails CLOSED)"},{"value":"quarantine-role","label":"Quarantine role on join (⚠ fails OPEN — needs a backstop)"}],"min":null,"max":null,"secret":false},{"name":"role","label":"Verified role (grant-access) or quarantine role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"channel","label":"Verification channel","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"alertChannel","label":"Alert channel","type":"channel","required":false,"help":"Where I shout when the gate cannot be enforced","choices":null,"min":null,"max":null,"secret":false},{"name":"method","label":"How they verify","type":"enum","required":false,"help":"","choices":[{"value":"button","label":"Button press"},{"value":"image","label":"Image challenge (harder for scripts, still not a captcha)"}],"min":null,"max":null,"secret":false},{"name":"backstop","label":"If quarantine fails","type":"enum","required":false,"help":"","choices":[{"value":"timeout","label":"Time them out (recommended — reversible)"},{"value":"kick","label":"Kick them (most closed, least recoverable)"},{"value":"alert-only","label":"⚠ Alert only — they stay in, unverified"}],"min":null,"max":null,"secret":false}]},
    {"id":"verify.arm","label":"Verification — arm / disarm","help":"Switch the gate on or off. Arming starts holding every new member.","group":"members","emoji":"🔒","module":"verification","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageRoles"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"on","label":"On or off","type":"enum","required":true,"help":"","choices":[{"value":"on","label":"Arm the gate"},{"value":"off","label":"Disarm"}],"min":null,"max":null,"secret":false}]},
    {"id":"verify.panel","label":"Verification — post the panel","help":"Post (or refresh) the card an unverified member presses.","group":"members","emoji":"📌","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["ViewChannel","SendMessages"],"mode":"all","scope":"channel","param":"channel","hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"channel","label":"Channel (defaults to the verification channel)","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"verify.member","label":"Verification — verify or reset a member","help":"Push somebody through the gate by hand, or send them back to it.","group":"members","emoji":"✅","module":"verification","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":{"need":["ManageRoles"],"mode":"all","scope":"guild","param":null,"hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"member","label":"Member","type":"member","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"action","label":"What to do","type":"enum","required":true,"help":"","choices":[{"value":"verify","label":"Verify them"},{"value":"reset","label":"Send them back to the gate"}],"min":null,"max":null,"secret":false}]},
    {"id":"verify.age","label":"Minimum account age (standing)","help":"A permanent floor on how old a Discord account must be. Unlike raid mode, this is always on.","group":"members","emoji":"🕰️","module":"verification","permission":"admin","destructive":true,"confirm":true,"dryRun":true,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"on","label":"On or off","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"minDays","label":"Minimum account age in days","type":"count","required":false,"help":"","choices":null,"min":1,"max":3650,"secret":false},{"name":"action","label":"What to do with a younger account","type":"enum","required":false,"help":"","choices":[{"value":"gate","label":"Hold them at the verification gate (recommended)"},{"value":"timeout","label":"Time them out"},{"value":"kick","label":"Kick them"},{"value":"flag","label":"Just tell staff"}],"min":null,"max":null,"secret":false},{"name":"timeout","label":"Timeout length","type":"duration","required":false,"help":"Used when the action is “time them out”. Max 28d","choices":null,"min":null,"max":null,"secret":false}]},
    {"id":"verify.rules","label":"Rules acceptance gate","help":"Make members accept your rules before they get in. Editing the text bumps the version.","group":"members","emoji":"📜","module":"verification","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"on","label":"On or off","type":"enum","required":false,"help":"","choices":[{"value":"on","label":"On"},{"value":"off","label":"Off"}],"min":null,"max":null,"secret":false},{"name":"text","label":"The rules","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"regate","label":"⚠ Re-gate everyone when the rules change","type":"enum","required":false,"help":"","choices":[{"value":"off","label":"No (recommended)"},{"value":"on","label":"Yes — un-verify everyone on every edit"}],"min":null,"max":null,"secret":false}]},
    ...
    {"id":"social.feed.add","label":"Social alerts — watch something","help":"A Twitch channel going live, a YouTube channel uploading, a subreddit posting, or any RSS/Atom feed. The first poll records what is already there and announces none of it.","group":"bot","emoji":"➕","module":"social-alerts","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":{"need":["ViewChannel","SendMessages"],"mode":"all","scope":"channel","param":"channel","hierarchy":null,"hierarchyParam":null,"verb":null},"params":[{"name":"service","label":"Service","type":"enum","required":true,"help":"","choices":[{"value":"twitch","label":"🟣 Twitch"},{"value":"youtube","label":"🔴 YouTube"},{"value":"reddit","label":"🟠 Reddit"},{"value":"rss","label":"📰 RSS / Atom"},{"value":"kick","label":"🟩 Kick — not supported"},{"value":"tiktok","label":"⬛ TikTok — not supported"},{"value":"twitter","label":"⬜ X / Twitter — not supported"}],"min":null,"max":null,"secret":false},{"name":"target","label":"Who or what to watch","type":"string","required":true,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"channel","label":"Post alerts in","type":"channel","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"role","label":"Ping this role","type":"role","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"name","label":"A name for this feed (optional)","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"template","label":"Message template (blank = the default)","type":"string","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
    ...
    {"id":"social.poll","label":"Social alerts — check now","help":"Polls every feed that is due and posts anything new. Preview first to see what WOULD be posted without posting it or marking anything as announced.","group":"bot","emoji":"🔄","module":"social-alerts","permission":"admin","destructive":false,"confirm":false,"dryRun":false,"bulk":false,"composite":false,"botPermission":null,"params":[{"name":"preview","label":"Preview only — post nothing","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false},{"name":"all","label":"Check every feed, not just the ones that are due","type":"boolean","required":false,"help":"","choices":null,"min":null,"max":null,"secret":false}]},
